...
load from "20190222_qxt_group_access.unl" insert into qxt_group_access;

delete from qxt_menu_item_txt where 1 = 1 ;
load from "20190222_qxt_menu_item_txt.unl" insert into qxt_menu_item_txt;

delete from qxt_menu_item where 1 = 1 ;
load from "20190222_qxt_menu_item.unl" insert into qxt_menu_item;
commit work;
