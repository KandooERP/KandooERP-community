...
INSERT INTO kandoooption values ('KA','GW','D2','Report - Show RMS Report Print Dialog Window (rmsreps)', 'Y');
DELETE FROM kandoooption WHERE cmpy_code = '99' and module_code = 'GW' and feature_code = 'D2';
INSERT INTO kandoooption values ('99','GW','D2','Report - Show RMS Report Print Dialog Window (rmsreps)', 'N');