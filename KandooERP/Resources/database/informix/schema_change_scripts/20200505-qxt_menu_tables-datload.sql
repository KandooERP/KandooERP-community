...
load from unl/20200505_qxt_menu_item.unl insert into qxt_menu_item;
load from unl/20200505_qxt_menu_item_txt.unl insert into qxt_menu_item_txt;
load from unl/20200505_qxt_run_arg.unl insert into qxt_run_arg;
--commit work;
