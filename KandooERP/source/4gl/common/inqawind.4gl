...
#
#   iniswind.4gl - show_qty_adj
#                  Window FUNCTION FOR showing a product ledger A type
#                  transaction, which IS a quantity adjustment.
#
GLOBALS "../common/glob_GLOBALS.4gl" 

FUNCTION show_qty_adj(p_cmpy,p_part_code,p_ware_code,p_tran_date,p_seq_num) 
	...
	OPEN WINDOW i123 with FORM "I123" 
