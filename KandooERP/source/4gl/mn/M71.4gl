...
FUNCTION getrecorder() 
	...
	DISPLAY ARRAY pa_mpsdemand TO sr_recorder.* 
		...
		BEFORE DISPLAY 
			CALL publish_toolbar("kandoo","M71","display-arr-mpsdemand") 
