...
# Purpose - BOR Maintenance - Globals & main
...
MAIN 
	...
	IF status = notfound THEN 
		...
		# prompt "Manufacturing parameters NOT SET up - Any key TO continue"
		EXIT program 
	END IF 
	...
	IF status = notfound THEN 
		...
		# prompt "Inventory parameters NOT SET up - Any key TO continue"
		EXIT program 
	END IF 
	...
	IF num_args() > 0 THEN 
		CALL edit_bor(arg_val(1), arg_val(2)) 
	ELSE 
		CALL bor_query() 
	END IF 
