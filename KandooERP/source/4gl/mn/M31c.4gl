...
# Purpose - Shop Order Add - Component/By Product details entry SCREEN &
#                            Instruction details entry SCREEN
############################################################
...
FUNCTION show_costs() 
	...
	DISPLAY fv_unit_cost_amt, fv_ext_cost_amt, fv_ext_price_amt 
	TO unit_cost_amt, ext_cost_amt, ext_price_amt 
