...
#
###########################################################################
# \brief module P61 allows the user TO enter Payables debits , distribute the
#             debits TO G/L accounts THEN apply the debit TO vouchers..
...
MAIN 
	...
	#    #5016 Account payable Parameters Not Set Up - "
	#    EXIT PROGRAM
	# END IF
	...
	WHILE true 
		...
		ELSE 
			...
			MENU " Debits" 
				...
				BEFORE MENU 
					CALL publish_toolbar("kandoo","P61","menu-debits-1") 
				...
				COMMAND "Distribution" " Enter account distribution FOR this debit" 
					...
					END IF 
					CLOSE WINDOW wp170 
				COMMAND "Apply" " Apply this debit TO Vouchers" 
					CALL apply_debit(glob_rec_kandoouser.cmpy_code, l_rec_debithead.debit_num) 
