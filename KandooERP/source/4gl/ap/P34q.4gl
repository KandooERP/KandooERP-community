...
# Description.: Modified P34r TO create P34q Remittance section AT the top
############################################################
...
REPORT P34A_rpt_list(p_rpt_idx,p_rec_tentpays,p_cheque_date,p_source_ind,p_source_text,p_doc_id) 
	...
	FORMAT 
		PAGE HEADER 
			...
			END IF 
			PRINT 
			COLUMN 003, l_rec_vendor.vend_code CLIPPED, 
			COLUMN 014, l_arr_address[1], ###-name text-### 
			COLUMN 045, TODAY         USING "dd/mm/yy", 
			COLUMN 057, l_page_number USING "##&" 
			SKIP 6 LINES 
		...
		ON EVERY ROW 
			...
			PRINT 
			COLUMN 005, l_rec_voucher.vouch_date USING "dd/mm/yy", 
			COLUMN 018, l_rec_voucher.inv_text[1,15], 
			COLUMN 033, l_voucher_total          USING "--,---,--&.&&", 
         ...
         LET glob_arr_rec_rpt_rmsreps[p_rpt_idx].page_num = pageno
			...
			PAGE TRAILER 
				...
				IF l_printchq_ind THEN 
					###-Print the totals-###
					PRINT COLUMN 033, l_cheque_total USING "--,---,--&.&&", 
					COLUMN 050, "" 
					SKIP 8 LINES 
					###-Print the cheque portion-###
					###-Line 50-###
					PRINT COLUMN 012, l_cheque_total USING "--,---,--&.&&" 
					SKIP 2 line 
					...
					LET l_cents = c8 
					PRINT 
					COLUMN 004, l_millions CLIPPED, 
					COLUMN 011, l_hundthous CLIPPED, 
					COLUMN 018, l_tensthous CLIPPED, 
					COLUMN 025, l_thous CLIPPED, 
					COLUMN 032, l_hund CLIPPED, 
					COLUMN 039, l_tens CLIPPED, 
					COLUMN 046, l_xunits CLIPPED, 
					COLUMN 053, l_cents USING "&&", 
					COLUMN 065, TODAY   USING "dd/mm/yy" 
					SKIP 2 LINES 
					###-Line 57-###
					PRINT 
					COLUMN 010, l_arr_address[1], 
					COLUMN 059, l_cheque_total USING "*,***,**&.&&" 
					PRINT COLUMN 010, l_arr_address[2] 
					PRINT COLUMN 010, l_arr_address[3] 
					PRINT COLUMN 010, l_arr_address[4] 
					PRINT COLUMN 010, l_arr_address[5] 
				ELSE 
					LET l_page_number = l_page_number + 1 
					###-Print the totals-###
					PRINT COLUMN 033, l_cheque_amt USING "-,---,--&.&&", 
					COLUMN 050, "<Continued Over Page>" 
					SKIP 8 LINES 
					###-Line 50-###
					PRINT COLUMN 014, "*****VOID*****" 
					SKIP 2 line 
