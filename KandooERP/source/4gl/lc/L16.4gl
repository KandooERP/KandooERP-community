...
# \file
# \brief module L16  allows the user TO Scan Shipment Vouchers by Shipment
...
FUNCTION selectship() 
	...
	ship_status_code 
		...
		BEFORE CONSTRUCT 
			CALL publish_toolbar("kandoo","L16","construct-ship_code-1") -- albo 
	...
	ELSE 
		...
		#W1002 " Searching database - please wait"
		...
		BEFORE FIELD ship_type_code 
			...
			ELSE 
				...
				IF pr_cnt = 0 THEN 
					...
					#9007 No Vouchers found matching selection criteria
				ELSE 
					CALL ship_dist(glob_rec_kandoouser.cmpy_code, pr_shiphead.ship_code, 
