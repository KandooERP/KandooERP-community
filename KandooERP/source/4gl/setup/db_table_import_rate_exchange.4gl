...
MAIN
	...
	CALL rate_exchangeMenu()
	
#CALL import_rate_exchange()
#unload_rate_exchange()
#import_rate_exchange()
#delete_rate_exchange_all()
#getrate_exchangeCount() --Count all rate_exchange rows FROM the current company	
