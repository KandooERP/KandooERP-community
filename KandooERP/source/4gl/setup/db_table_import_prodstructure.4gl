...
MAIN
	...
	CALL prodstructureMenu()
	
#CALL import_prodstructure()
#unload_prodstructure()
#import_prodstructure()
#delete_prodstructure_all()
#getprodstructureCount() --Count all prodstructure rows FROM the current company	
