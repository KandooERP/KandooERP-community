...
# \file
# \brief module I27a - Allows the user TO enter product quantity adjustments
# FOR fifo costing
...
FUNCTION doit() 
	DEFINE ans CHAR(1)
	DEFINE i SMALLINT
	DEFINE usr_esc SMALLINT
	DEFINE where_part STRING
	DEFINE sel_text STRING
	LET int_flag = 0 
	LET quit_flag = 0 

	OPEN WINDOW wi203 with FORM "I203" 
	 CALL windecoration_i("I203") 

	LET msgresp = kandoomsg("U",1001,"") 
	#1001 "Enter selection criteria AND ESC TO begin search"
	...
	product.desc_text 
		...
		BEFORE CONSTRUCT 
			CALL publish_toolbar("kandoo","I27a","construct-prodstatus-1") -- albo kd-505 
	...
	#1051 Enter on line TO enter adjustment; F3 Pg-Up; F4 Pg-Down
	...
	WHILE true 
		...
		INPUT ARRAY pa_product WITHOUT DEFAULTS FROM sr_product.* 
			...
			BEFORE INPUT 
				CALL publish_toolbar("kandoo","I27a","input-arr-pa_product-1") -- albo kd-505 
