...
# FUNCTION E52_S_main()
#
# E52 (E52_S!!!)- Packing Slip / Picking List Print Program
###########################################################################
FUNCTION E52_S_main() 
	DEFINE i SMALLINT 
	...
	MENU "Picking lists" 
		BEFORE MENU 
			CALL publish_toolbar("kandoo","E52_S","menu-Picking_Lists-1") -- albo kd-502 
		...
		COMMAND "Generate" " SELECT criteria AND generate picking lists" 
			...
			LET temp_text = select_criteria(glob_rec_kandoouser.cmpy_code) 

			IF generate_pick(glob_rec_kandoouser.cmpy_code,glob_rec_kandoouser.sign_on_code,temp_text) THEN 
				...
				FOREACH c_picklist INTO l_rec_orderhead.ware_code, 
					l_rec_orderhead.delivery_ind 
					CALL create_picklist(glob_rec_kandoouser.cmpy_code,glob_rec_kandoouser.sign_on_code,
					l_rec_orderhead.ware_code,l_rec_orderhead.delivery_ind, 
					TRUE,TRUE)
					SLEEP 2 
				END FOREACH 
