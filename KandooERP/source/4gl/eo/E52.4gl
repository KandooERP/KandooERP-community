...
# FUNCTION E52_main()
#
# E52 - Packing Slip / Picking List Print Program
#               Provides front END TO print_pickslip() (E52a.4gl).
###########################################################################
FUNCTION E52_main() 
	DEFINE i INTEGER 
	...
	DEFINE l_select_criteria_text STRING 
	...
	MENU " Picking lists" 
		BEFORE MENU 
			CALL publish_toolbar("kandoo","E52","menu-Picking_Lists-1") -- albo kd-502
		...
		COMMAND "REPORT" " SELECT criteria AND generate picking list (Report)" 
			OPEN WINDOW E152 with FORM "E152" 
			 CALL windecoration_e("E152")  

			LET l_select_criteria_text = select_criteria(glob_rec_kandoouser.cmpy_code) 

			IF generate_pick(glob_rec_kandoouser.cmpy_code,glob_rec_kandoouser.sign_on_code,l_select_criteria_text) THEN 
