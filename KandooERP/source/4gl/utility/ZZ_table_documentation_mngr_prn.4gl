...
# Generated on 2019-11-09 08:34:46
...
MAIN 
	...
	# CALL ui_init(0)
	LET m_program="p_ZZ_table_documentation_mngr_table_documentation" 


	CALL main_zz_table_documentation_mngr_table_documentation() 
...
##########################################################################
FUNCTION mc_zz_table_documentation_mngr_sccs() 
	## definition variable sccs
	DEFINE sccs_var CHAR(70) 
	LET sccs_var="%W% %D%" 
END FUNCTION 
##########################################################################
FUNCTION main_zz_table_documentation_mngr_table_documentation () 
	## this module's main function called by MAIN
	CALL init_program("kandoodb",m_program) 
	...
	CALL sql_prepare_queries_zz_table_documentation_mngr_table_documentation () # INITIALIZE all cursors ON master TABLE 
	CALL sql_prepare_queries_zz_table_documentation_mngr_column_documentation() 
	#@G00037


	CALL menu_zz_table_documentation_mngr_table_documentation() 
...
######################################################################
FUNCTION menu_zz_table_documentation_mngr_table_documentation () 
	## menu_ZZ_table_documentation_mngr_table_documentation
	## the top level menu
	...
	DEFINE pky_table_documentation RECORD 
		...
		#@G00058
	END RECORD 
	DEFINE frm_zz_table_documentation_mngr RECORD 
		tabname LIKE table_documentation.tabname, # varchar(128) 
	...
	DEFINE tbl_zz_table_documentation_mngr RECORD 
		tabname LIKE table_documentation.tabname, # varchar(128) 
		tabtype LIKE table_documentation.tabtype, # char(10) 
		language_code LIKE table_documentation.language_code, # char(3) 
		documentation LIKE table_documentation.documentation, # nvarchar(255) 
	...
	MENU "table_documentation" 
		BEFORE MENU 
			HIDE option "Next","Previous","EDIT","DELETE","View Array column_documentation","Edit Array column_documentation" 
		COMMAND "Query" "Query data with multiple criteria table_documentation" 
			#@G00075
			MESSAGE "" 
			INITIALIZE frm_zz_table_documentation_mngr.* TO NULL 
			CLEAR FORM 
			DISPLAY BY NAME frm_zz_table_documentation_mngr.* 
			HIDE option "Next","Previous" 


			CALL frm_query_zz_table_documentation_mngr() RETURNING nbsel_table_documentation 
			IF nbsel_table_documentation > 0 THEN 
				...
				CASE 
					WHEN record_found = 1 
						...
						RETURNING record_found,frm_zz_table_documentation_mngr.* 


						CALL frm_display_zz_table_documentation_mngr(frm_zz_table_documentation_mngr.*) 
						...
						SHOW option "View Array column_documentation","Edit Array column_documentation" 
						#@G00097
					WHEN record_found = -1 
			...
			ELSE 
				...
				NEXT option "Query" 
			END IF 
		COMMAND KEY (tab) "View Array column_documentation" 
			CALL display_array_column_documentation (pky_table_documentation.*,true) 
		COMMAND KEY (shift-tab) "Edit Array column_documentation" 
			CALL frm_edit_array_column_documentation (pky_table_documentation.*,true) 
			#@G00111


		COMMAND "Next" "Display Next record table_documentation" 
			#@G00113
			MESSAGE "" 
			CLEAR FORM 
			INITIALIZE frm_zz_table_documentation_mngr.* TO NULL 
		...
		COMMAND "INSERT" "Add a new record table_documentation" 
			#@G00192
			CALL frm_insert_zz_table_documentation_mngr() RETURNING sql_stmt_status,pky_table_documentation.* 
			SHOW option "Edit Array column_documentation" 
			CALL initialize_array_column_documentation() 
			CALL display_array_column_documentation (pky_table_documentation.*,false) 
			#@G00197


		COMMAND "EDIT" "Modify current record table_documentation" 
			#@G00199
			MESSAGE "" 
			IF nbsel_table_documentation THEN 
				IF sql_status_pk_table_documentation(pky_table_documentation.*) < 0 THEN 
					ERROR "is locked " 
					NEXT option "Next" 
				ELSE 
					CALL frm_edit_zz_table_documentation_mngr(pky_table_documentation.*,frm_zz_table_documentation_mngr.*) 
		...
		COMMAND "DELETE" "Suppress current record table_documentation" 
			#@G00214
			MESSAGE "" 
			IF nbsel_table_documentation THEN 
				IF sql_status_pk_table_documentation(pky_table_documentation.*) < 0 THEN 
				...
				WHILE true 
					...
					CASE 
						...
						WHEN ACTION = 2 
							CALL frm_delete_zz_table_documentation_mngr(pky_table_documentation.*) 
							RETURNING sql_stmt_status 
							EXIT WHILE 
					END CASE 
				END WHILE 
...
#######################################################################
FUNCTION frm_query_zz_table_documentation_mngr() 
	## frm_Query_ZZ_table_documentation_mngr_f_dbschema_documentation : Query By Example on table table_documentation
...
#######################################################################
# frm_Display_ZZ_table_documentation_mngr_f_dbschema_documentation : displays the form record after reading and displays lookup records if any
# inbound: Form record.*
FUNCTION frm_display_zz_table_documentation_mngr(frm_zz_table_documentation_mngr) 
	DEFINE frm_zz_table_documentation_mngr RECORD 
		tabname LIKE table_documentation.tabname, # varchar(128) 
		tabtype LIKE table_documentation.tabtype, # char(10) 
		language_code LIKE table_documentation.language_code, # char(3) 
...
END FUNCTION # frm_display_zz_table_documentation_mngr_f_dbschema_documentation 




####################################################################
## frm_Insert_ZZ_table_documentation_mngr_f_dbschema_documentation: add a new table_documentation row
FUNCTION frm_insert_zz_table_documentation_mngr() 
	...
	WHILE true 
		LET int_flag = false 
		INPUT BY NAME frm_zz_table_documentation_mngr.tabname, 
		frm_zz_table_documentation_mngr.tabtype, 
		frm_zz_table_documentation_mngr.language_code, 
		frm_zz_table_documentation_mngr.documentation, 
		frm_zz_table_documentation_mngr.mtime 

		#@G00334
		WITHOUT DEFAULTS 
			AFTER FIELD tabname 
				IF frm_zz_table_documentation_mngr.tabname IS NULL THEN 
					ERROR "This field is required" 
					NEXT FIELD tabname 
				END IF 
				IF sql_status_pk_table_documentation(frm_zz_table_documentation_mngr.language_code,frm_zz_table_documentation_mngr.tabname) THEN 
					ERROR "table_documentation: already exists" 
					NEXT FIELD tabname 
				END IF 
			AFTER FIELD language_code 
				IF frm_zz_table_documentation_mngr.language_code IS NULL THEN 
					ERROR "This field is required" 
		...
		CASE ACTION 
			...
			WHEN 2 # ON valide la transaction 
				BEGIN WORK 
					#@G00370
					CALL set_table_record_f_dbschema_documentation_table_documentation('+',frm_zz_table_documentation_mngr.*) 
					RETURNING tbl_zz_table_documentation_mngr.* 
					CALL sql_insert_table_documentation(tbl_zz_table_documentation_mngr.*) 
					RETURNING sql_stmt_status, tbl_zz_table_documentation_mngr.tabname,tbl_zz_table_documentation_mngr.language_code 
					#@G00374
		...
		END CASE 
	END WHILE 
	# tbl_ZZ_table_documentation_mngr
	RETURN sql_stmt_status, tbl_zz_table_documentation_mngr.tabname,tbl_zz_table_documentation_mngr.language_code 
	#@G00392
END FUNCTION ## frm_insert_zz_table_documentation_mngr_f_dbschema_documentation 




#######################################################################
# frm_Edit_ZZ_table_documentation_mngr_f_dbschema_documentation : Edit a table_documentation RECORD
# inbound: table primary key
FUNCTION frm_edit_zz_table_documentation_mngr(pky,frm_zz_table_documentation_mngr) 
	DEFINE ACTION SMALLINT 
	...
	DEFINE sav_zz_table_documentation_mngr RECORD 
		tabname LIKE table_documentation.tabname, # varchar(128) 
		tabtype LIKE table_documentation.tabtype, # char(10) 
		language_code LIKE table_documentation.language_code, # char(3) 
		documentation LIKE table_documentation.documentation, # nvarchar(255) 
	...
	WHILE true 
		...
		LET sav_zz_table_documentation_mngr.* = frm_zz_table_documentation_mngr.* 
		BEGIN WORK 
			...
			IF sqlca.sqlcode = -244 THEN ERROR "THIS ROW IS BEING MODIFIED" 
				...
				#@G00431
				INPUT BY NAME frm_zz_table_documentation_mngr.tabtype, 
				frm_zz_table_documentation_mngr.documentation, 
				frm_zz_table_documentation_mngr.mtime 
				...
				IF int_flag = true THEN 
					...
					LET frm_zz_table_documentation_mngr.* = sav_zz_table_documentation_mngr.* 
					DISPLAY BY NAME frm_zz_table_documentation_mngr.* 
					#@G00441
				...
				CASE 
					...
					WHEN ACTION = 2 
						...
						LET sql_stmt_status = sql_edit_table_documentation(pky.*,tbl_zz_table_documentation_mngr.*) 
						CASE 
							WHEN sql_stmt_status = 0 
...
END FUNCTION ## frm_edit_zz_table_documentation_mngr(pky) 
...
# inbound: table primary key
FUNCTION frm_delete_zz_table_documentation_mngr(pky) 
	DEFINE ACTION SMALLINT 
	...
	WHILE true 
		...
		BEGIN WORK 
			...
			END WHILE 
			RETURN sql_stmt_status 
END FUNCTION ## frm_delete_zz_table_documentation_mngr(pky) 


#########################################################################
#  Build, prepare, declare and initialize main queries and cursors
FUNCTION sql_prepare_queries_zz_table_documentation_mngr_table_documentation () 
...
END FUNCTION ## sql_prepare_queries_zz_table_documentation_mngr_table_documentation 
...
FUNCTION sql_fetch_full_row_table_documentation(pky_table_documentation) 
	...
	FETCH crs_row_table_documentation INTO tbl_zz_table_documentation_mngr.* 
	...
	CASE 
		...
		OTHERWISE 
			LET sql_stmt_status = 1 
			CALL set_form_record_zz_table_documentation_mngr(tbl_zz_table_documentation_mngr.*) 
			RETURNING frm_zz_table_documentation_mngr.* 
	END CASE 
	RETURN sql_stmt_status,frm_zz_table_documentation_mngr.* 
END FUNCTION ## sql_fetch_full_row_table_documentation 


########################################################################
FUNCTION sql_insert_table_documentation(tbl_zz_table_documentation_mngr) 
	...
	USING tbl_zz_table_documentation_mngr.tabname, 
	tbl_zz_table_documentation_mngr.tabtype, 
	tbl_zz_table_documentation_mngr.language_code, 
	tbl_zz_table_documentation_mngr.documentation, 
	tbl_zz_table_documentation_mngr.mtime 
	#@G00748
	WHENEVER SQLERROR CALL error_mngmt 
...
########################################################################
FUNCTION sql_edit_table_documentation(pky,tbl_zz_table_documentation_mngr) 
	...
	USING tbl_zz_table_documentation_mngr.tabtype, 
	tbl_zz_table_documentation_mngr.documentation, 
	tbl_zz_table_documentation_mngr.mtime 
	, #@g00774 
	pky.* 
...
################################################################################################
FUNCTION set_form_record_zz_table_documentation_mngr(tbl_contents) 
	## set_form_record_ZZ_table_documentation_mngr_f_dbschema_documentation: assigns table values to form fields values
	...
	#@G00854
	RETURN frm_contents.* 
END FUNCTION ## set_form_recordzz_table_documentation_mngr_f_dbschema_documentation 
