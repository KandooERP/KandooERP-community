...
DEFINE pky_array_column_documentation DYNAMIC ARRAY OF RECORD 
...
DEFINE scr_array_column_documentation DYNAMIC ARRAY OF RECORD 
	colno LIKE column_documentation.colno, # INTEGER 
	colname LIKE column_documentation.colname, # varchar(128) 
	datatype VARCHAR(30), 
	documentation LIKE column_documentation.documentation, # nvarchar(255) 
...
DEFINE tbl_column_documentation RECORD 
	tabname LIKE column_documentation.tabname, # varchar(128) 
	colname LIKE column_documentation.colname, # varchar(128) 
	language_code LIKE column_documentation.language_code, # char(3) 
	colno LIKE column_documentation.colno, # INTEGER 
...
FUNCTION sql_prepare_queries_z_table_documentation_mngr_column_documentation () 
	...
	LET query_text = "SELECT '=', column_documentation.tabname,column_documentation.colname,column_documentation.language_code,", #@g00027 
	"column_documentation.colno,", 
	"column_documentation.colname,", 
	"1,", 
	"column_documentation.documentation,", 
	"column_documentation.mtime", 

	#@G00031
	" FROM column_documentation, ", 
	"table_documentation ", 
	"WHERE column_documentation.tabname = table_documentation.tabname ", 
	"AND column_documentation.language_code = table_documentation.language_code ", 
	#@G00032
	" AND column_documentation.tabname = ? 
	...
	LET query_text = 
	"INSERT INTO column_documentation ( tabname,colname,language_code,colno,documentation,mtime 
	)", #@G00041 
	" VALUES ( ?,?,?,?,?,? 
	)" #@G00042 
...
FUNCTION sql_insert_column_documentation(lr_column_documentation) 
	...
	DEFINE lr_column_documentation RECORD 
		tabname LIKE column_documentation.tabname, # varchar(128) 
		colname LIKE column_documentation.colname, # varchar(128) 
		language_code LIKE column_documentation.language_code, # char(3) 
		colno LIKE column_documentation.colno, # INTEGER 
	...
	lr_column_documentation.documentation, 
	...
	CASE 
		...
		WHEN sqlca.sqlcode < 0 
			CALL display_error2("sql_Insert column_documentation:failed ",sqlca.sqlcode) 
...
FUNCTION sql_edit_column_documentation(pky,lr_column_documentation) 
	...
	USING lr_column_documentation.colno, 
	lr_column_documentation.documentation, 
	lr_column_documentation.mtime 
	, #@g00125 
	pky.* 
	...
	CASE 
		...
		WHEN sqlca.sqlcode < 0 
			CALL display_error2("sql_Edit column_documentation:failed ",sqlca.sqlcode) 
			LET lsql_stmt_status = -1 
...
FUNCTION sql_delete_column_documentation(pky) 
	...
	CASE 
		...
		WHEN sqlca.sqlcode < 0 
			CALL display_error2("sql_Delete column_documentation:failed ",sqlca.sqlcode) 
			LET lsql_stmt_status = -1 
	END CASE 
...
FUNCTION frm_edit_array_column_documentation (p_rec_pky_table_documentation) 
	...
	DEFINE fky RECORD 
		...
		#@G00256
	END RECORD 
	DEFINE p_rec_pky_table_documentation RECORD 
		tabname LIKE column_documentation.tabname, # varchar(128) 
		colname LIKE column_documentation.colname, # varchar(128) 
		language_code LIKE column_documentation.language_code # char(3) 
		#@G00259
	...
	BEGIN WORK 
		#@G00261
		WHILE true 
			CALL frm_input_array_column_documentation (p_rec_pky_table_documentation.*) RETURNING nbr_edited_rows,sql_action 
			#@G00262
...
FUNCTION frm_input_array_column_documentation (pky_table_documentation) 
	...
	DEFINE pky_table_documentation RECORD 
		...
		#@G00309
	END RECORD 
	DEFINE sav_scr_array_column_documentation RECORD 
		colno LIKE column_documentation.colno, # INTEGER 
		colname LIKE column_documentation.colname, # varchar(128) 
		documentation LIKE column_documentation.documentation, # nvarchar(255) 
		mtime LIKE column_documentation.mtime # DATETIME year TO second 
...
FUNCTION set_form_record_f_dbschema_documentation_sr_columndoc(tbl_contents) 
	...
	LET frm_contents.colname = tbl_column_documentation.colname 
	LET frm_contents.documentation = tbl_column_documentation.documentation 
	LET frm_contents.mtime = tbl_column_documentation.mtime 
	#@G00410
	CASE 
		WHEN status = 0 
			LET fgl_status = 1 
...
FUNCTION set_table_record_f_dbschema_documentation_column_documentation(sql_stmt,fky,pky,element_contents) 
	...
	CASE sql_stmt 
		WHEN "+" -- SET TABLE RECORD TO INSERT ROW 
			...
			LET tbl_contents.documentation = element_contents.documentation 
...
FUNCTION array_bulk_update_column_documentation (p_rec_parent_fky) 
	...
	DEFINE elements_contents RECORD 
		...
		#@G00485
	END RECORD 
	DEFINE l_column_documentation RECORD 
		tabname LIKE column_documentation.tabname, # varchar(128) 
		colname LIKE column_documentation.colname, # varchar(128) 
		language_code LIKE column_documentation.language_code, # char(3) 
		colno LIKE column_documentation.colno, # INTEGER 
...
FUNCTION get_datatype(l_tabname,l_colname) #@g00534 
	...
	IF sqlca.sqlcode = 100 THEN 
		RETURN "Table not found in kandoo" 
	END IF 
