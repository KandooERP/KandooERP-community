...
# Generated on 2018-09-15 11:27:18		                                                                                       	
# template E:\Users\BeGooden-IT\Projects\QuerixTools\ffg/templates/child_standard.mtplt 		                                 	
############################################################
...
FUNCTION prepare_queries_frm_obj_translate_attributes_translation () 
	# this function INITIALIZEs all cursors AND prepared statements for the attributes_translation AND lookups		            	
	#################################################################################################		                        	
	DEFINE query_text STRING 
	# Prepare the CURSOR TO display the attributes_translation array		                                                     	
	# using foreign key pointing TO form_attributes		                                                                      	
...
FUNCTION open_array_crs_attributes_translation_sr_array(fky) 
	# This function opens the main CURSOR for the table attributes_translation		                                            	
	#######################################################################		                                                  	
...
########################################################################		                                                 	
## INSERT in table attributes_translation 		                                                                            	
########################################################################		                                                 	
...
########################################################################		                                                 	
## sql_update_attributes_translation :UPDATE current attributes_translation record		                                 	
########################################################################		                                                 	
...
########################################################################		                                                 	
## delete_attributes_translation :delete Selected row in table attributes_translation 		                             	
########################################################################		                                                 	
...
FUNCTION display_array_attributes_translation (fky,browse) 
	# This function displays the array data (attributes_translation_sr_array) based on the foreign key 		                   	
...
FUNCTION edit_array_attributes_translation (p_rec_ky_form_attributes) 
	# This function calls the INPUT array function (input_array_attributes_translation) TO edit the array data		            	
...
FUNCTION input_array_attributes_translation (pky_form_attributes) 
	## this function operates INPUT ARRAY for the table attributes_translation		                                            	
	# it handles 3 arrays:		                                                                                                   	
	# 1) The STATUS array  (attributes_translation_status_array) contains the STATUS for each element: 		                   	
	#    NULL=>no data, 0=>elements NOT touched, 1=>element TO INSERT, 2=>element TO UPDATE, -1=>element TO DELETE		           	
	# 2) the Input Data Array (attributes_translation_sr_array) will contain the data input by the user		                   	
	# 3) the primary key array (pky_form_attributes) contains the primary key VALUES of each element		                      	
	###################################################################################################################		      	
...
FUNCTION set_form_record_frm_obj_translate_arr_translation(tbl_contents) 
	# This function assigns the VALUES FROM the table arr_translation TO the form record frm_contents		                                 	
	######################################################################################################		                   	
...
######################################################################################################		                   	
FUNCTION set_table_record_frm_obj_translate_attributes_translation(fky,sql_stmt,pky,element_contents) 
	# This function assigns the VALUES FROM the array element(element_contents) TO the table record (tbl_contents)		           	
	# It distinguishes the primary key (pky) of the table attributes_translationand the foreign key (fky) point TO the parent table (form_attributes)			
	######################################################################################################		                   	
	...
	LET tbl_contents.attribute_id = pky.attribute_id 
	IF sql_stmt = 1 THEN 
		LET tbl_contents.language = element_contents.language 
	END IF 
	LET tbl_contents.translation = element_contents.translation 
...
FUNCTION array_bulk_update_attributes_translation (fky) 
	## This functions browses the STATUS array attributes_translation_status_array,		                                       	
	# copies the element VALUES TO table VALUES (attributes_translation)		                                                  	
