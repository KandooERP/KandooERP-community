...
GLOBALS "../pu/RB6_GLOBALS.4gl"  

DEFINE mdou_start_flg INTEGER 

#RB6 Commitments Report - by GL Account Code
FUNCTION RB6_main() 
	DEFER quit 
	DEFER interrupt
	
	CALL setModuleId("RB6") 
	...
	CASE rpt_init_url_get_operation_method_exec_ind() #url-arg 1=menu 2=batch 3=construct 4=query
		WHEN "1" #UI/MENU Mode 	
			...
			MENU " ORDER BY GL Account" 
				...
				BEFORE MENU 
					CALL publish_toolbar("kandoo","RB6","menu-order_by_gl_acc-1") 
					CALL RB6_rpt_process(RB6_rpt_query())
		...
		WHEN "2" #Background Process with rmsreps.report_code
			CALL RB6_rpt_process(NULL)  

		WHEN "3" #Only create query-where-part
			OPEN WINDOW R124 with FORM "R124" 
			CALL  windecoration_r("R124") 
			CALL displaymoduletitle(NULL) --first FORM OF the module get's the title 
			CALL set_url_sel_text(RB6_rpt_query()) #save where clause in env 
			CLOSE WINDOW R124 
			
		WHEN "4" #Background Process with SQL WHERE ARGUMENT
			CALL RB6_rpt_process(get_url_sel_text())
	END CASE			 
END FUNCTION 


FUNCTION RB6_rpt_query() 
	...
	purchdetl.acct_code 
		...
		BEFORE CONSTRUCT 
			CALL publish_toolbar("kandoo","RB6","construct-purchdetl-1") 
...
FUNCTION RB6_rpt_process(p_where_text) 
	...
	glob_arr_rec_rpt_rmsreps[rpt_rmsreps_idx_get_idx("RB6_rpt_list")].sel_text clipped," ",  
	...
	WHILE true 
		...
		#---------------------------------------------------------
		OUTPUT TO REPORT RB6_rpt_list(l_rpt_idx,
	...
	#------------------------------------------------------------
	FINISH REPORT RB6_rpt_list
	CALL rpt_finish("RB6_rpt_list")
	#------------------------------------------------------------
...
REPORT RB6_rpt_list(p_rpt_idx,pr_purchdetl,pr_curr_code,pr_order_date,pr_conv_qty) 
	...
	FORMAT 
		...
		ON LAST ROW 
			...
			COLUMN 103,order_amt_ggtot-received_amt_ggtot 
			USING "------,---.&&", 
			COLUMN 117,order_amt_ggtot - voucher_amt_ggtot 
			USING "------,---.&&" 
			SKIP 1 line 
